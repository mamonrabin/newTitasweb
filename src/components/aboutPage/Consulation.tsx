  ...
  return (
    <div className="mt-20">
      ...
      >
        ...
        >
          <p
            className={`${exo.className} uppercase font-bold text-base text-white`}
          >
            Ready to Work Together?
          </p>
          <h2
            className={`${exo.className} py-4 font-bold lg:text-5xl text-3xl lg:leading-13 text-white mt-2 lg:w-[60%]`}
          >
